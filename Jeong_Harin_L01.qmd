...
Supervised learning involves labeled data with corresponding outputs. Unsupervised learning uses unlabeled data without predefined outputs. It is used to uncover new insights, such as patterns or relationships, about the data.
...
Mechanistic models depend on known, fundamental laws. 
